...
def gameover_screen(screen, player_id, score):
    ...
    font = pygame.font.Font("assets/emulogic.ttf", 15)
    small_font = pygame.font.Font("assets/emulogic.ttf", 12)
    ...
    while True:
        ...
        screen.blit(font.render(f"Your score -{score}", True, (255, 255, 255)), (300, 120))

        screen.blit(small_font.render("Leaders", True, (255, 255, 255)), (330, 170))
        ...
        screen.blit(small_font.render("Try again", True, (255, 255, 255)), (button_rect.x + 35, button_rect.y + 15))
        screen.blit(small_font.render("Exit", True, (255, 255, 255)), (quit_rect.x + 75, quit_rect.y + 15))
