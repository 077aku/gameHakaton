...
class GameplayScreen:
    def __init__(self, screen, player_id):
        ...
        self.background = pygame.transform.scale(pygame.image.load(ASSETS["background"]), (WIDTH, HEIGHT))
        ...
        while running:
            ...
            for bullet in self.bullets:
                ...
                if hit_enemy:
                    ...
                    expl = AnimatedSprite(ASSETS["explosion_anim"], 64, 64, 5, hit_enemy.rect.center)
            ...
            # Отрисовка эффектов вокруг игрока
